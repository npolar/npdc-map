...
npdcMapApp.service(
  "MapImageService",
  require("./map-archive/image/MapImageService")
);
npdcMapApp.factory("MapArchive", require("./map-archive/edit/MapArchive"));
npdcMapApp.controller(
  "MapArchiveShowController",
  require("./map-archive/show/MapArchiveShowController")
);
npdcMapApp.controller(
  "MapArchiveSearchController",
  require("./map-archive/search/MapArchiveSearchController")
);
npdcMapApp.controller(
  "MapArchiveEditController",
  require("./map-archive/edit/MapArchiveEditController")
);
npdcMapApp.directive(
  "mapCoverage",
  require("./map-archive/edit/coverage/coverageDirective")
);
...
resources.forEach(service => {
  ...
  npdcMapApp.factory(service.resource, [
    "NpolarApiResource",
    function(NpolarApiResource) {
...
npdcMapApp.run(
  ($http, npolarApiConfig, npdcAppConfig, NpolarTranslate, NpolarLang) => {
    ...
    $http
      .get(
        "https://api.npolar.no/text/?q=&filter-bundle=npdc-map&format=json&variant=array&limit=all"
      )
      .then(response => {
